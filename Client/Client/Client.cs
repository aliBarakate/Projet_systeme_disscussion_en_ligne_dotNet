            ...
            if (!exit)
            {
                connectButton.Invoke((MethodInvoker)delegate
                {
                    ...
                    if (status)
                    {
                        ...
                        Log(SystemMsg("Vous êtes maintenant connecté"));
                    }
                    else
                    {
                        ...
                        Log(SystemMsg("Vous êtes maintenant deconnecté"));
                    }
                });
            }
        }
        ...
        private void SendTextBox_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (sendTextBox.Text.Length > 0)
                {
                    ...
                    sendTextBox.Clear();
                    Log(string.Format("{0} (Vous): {1}", obj.username, msg));
                    if (connected)
                    {
                        Send(msg);
                    }
